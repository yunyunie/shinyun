...
- 首屏人物动画 `assets/intro.webm`（透明背景）+ `assets/intro.mp4`（奶黄底回落版）
- PUBG AI 视觉 4 张 `assets/lab/ai-visual/pubg-mobile/01–04.jpg`
- TikTok 案例 2 张 `assets/work/tiktok/v1–v2.jpg`
- 腾讯案例 2 张 `assets/work/tencent/v1、v3.jpg`

**还剩 4 个占位框**，都在 Journey 页，每座城市一张：

```
assets/journey/malaysia/01.jpg
assets/journey/beijing/01.jpg
assets/journey/shenzhen/01.jpg
assets/journey/seoul/01.jpg
```

把照片按这个路径和文件名放进去，然后打开 `journey.html`，
把对应的 `<div class="ph ...">…</div>` 换成：

```html
<img src="assets/journey/beijing/01.jpg" loading="lazy"
     data-i18n-alt="ph.photo" alt="">
```

图片建议裁成 4:3、宽度 1600px 以内、JPEG 质量 82 左右。
